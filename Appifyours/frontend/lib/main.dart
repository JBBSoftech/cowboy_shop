...
class ApiConfig {
  ...
  static String get adminObjectId => '695cd3bc9d407628795684fb'; // Will be replaced during publish
...
class AdminManager {
  ...
  static Future<String> getCurrentAdminId() async {
    ...
    if (adminId == '695cd3bc9d407628795684fb' || adminId.isEmpty) {
    ...
    if (ApiConfig.adminObjectId != '695cd3bc9d407628795684fb' && ApiConfig.adminObjectId.isNotEmpty) {
      assert(
